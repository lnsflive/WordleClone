...
<template>
    <div
        ...
        'scale-100': !pulse,
        'scale-105': pulse,
        'border-gray-500 bg-gray-500 text-white animate-flip': color == 'gray',
        'border-green-600 bg-green-600 text-white animate-flip': color == 'green',
        'border-yellow-500 bg-yellow-500 text-white animate-flip': color == 'yellow',
        }"
    >
        {{letter}}
    </div>
